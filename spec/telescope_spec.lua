...
describe(
    ...
    function()
        ...
        context(
            ...
            function()
                it(
                    "should have a 'version' member",
                    function()
                        assert_equal("string", type(telescope.version))
                    end
                )
                it(
                    "should have a '_VERSION' member",
                    function()
            ...
            function()
                ...
                context(
                    ...
                    function()
                        ...
                        it(
                            "should have a parent of 0 when at the top level",
                            function()
                                assert_equal("A context", contexts[1].name)
                ...
                context(
                    ...
                    function()
                        it(
                            "when pending, should have true for the 'test' field",
                            function()
                        ...
                        it(
                            "when non-pending, should have a function for the 'test' field",
                            function()
                ...
                context(
                    ...
                    function()
                        it(
                            "should accept a function or a path to a module",
                            function()
